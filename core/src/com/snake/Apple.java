...
public class Apple {
    ...
    public void setX(int SNAKE_MOVEMENT){
        this.appleX = MathUtils.random((60 + (Gdx.graphics.getWidth() - 120)) / SNAKE_MOVEMENT - 1) * SNAKE_MOVEMENT;
    }

    public void setY(int SNAKE_MOVEMENT){
        this.appleY = MathUtils.random((60 + (Gdx.graphics.getHeight() - 120)) / SNAKE_MOVEMENT - 1) * SNAKE_MOVEMENT;
    }
